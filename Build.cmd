...
IF "%ARG2%" == "" SET /P BUILD_TARGET=Please select the build target to use (b = build only [Default], u = build and package umbraco):
...
CALL Build\Tools\NuGet\NuGet.exe restore Source\TeaCommerce.StarterKit.sln
