...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "2bf8e7561f589df1")]
...
#pragma warning restore 0109
	...
	/// <summary>Product search page</summary>
	[PublishedContentModel("productSearchPage")]
	public partial class ProductSearchPage : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "productSearchPage";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ProductSearchPage(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ProductSearchPage, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
